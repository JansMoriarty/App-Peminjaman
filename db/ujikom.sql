...
--
-- Host: localhost:3306
-- Generation Time: Oct 10, 2024 at 05:07 AM
...
CREATE TABLE `tm_barang_inventaris` (
  ...
  `br_status` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE `td_peminjaman_barang`
  ...
  ADD CONSTRAINT `td_peminjaman_barang_ibfk_2` FOREIGN KEY (`br_kode`) REFERENCES `tm_barang_inventaris` (`br_kode`);

--
-- Constraints for table `tm_barang_inventaris`
--
ALTER TABLE `tm_barang_inventaris`
  ADD CONSTRAINT `tm_barang_inventaris_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tm_user` (`user_id`),
  ADD CONSTRAINT `tm_barang_inventaris_ibfk_2` FOREIGN KEY (`jns_brg_kode`) REFERENCES `tr_jenis_barang` (`jns_brg_kode`);
